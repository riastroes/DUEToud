...
function initCanvasUI(){
    ...
    horruler.style.top = "94px";
    horruler.style.left = (marge-20) + "px";
    verruler.style.top = "94px";
    verruler.style.left = (marge-20) + "px";



    canvas.style.top = "114px";
    canvastop.style.top = "114px";
    canvasbg.style.top = "114px";
